...
using Exception = Pulsar.Contexts.GlfwSharp.Binding.Exception;
...
namespace Pulsar.Contexts.GlfwSharp.Binding
{
    ...
    public class NativeWindow : SafeHandleZeroOrMinusOneIsInvalid, IEquatable<NativeWindow>
    {
        ...
        ///     <para>Returns <see cref="Binding.Monitor.None" /> if window is not fullscreen.</para>
        /// </summary>
        /// <value>
        ///     The monitor.
        /// </value>
        ...
        ///     <para>If window is not fullscreen, returns the <see cref="Binding.VideoMode" /> for the primary monitor.</para>
        /// </summary>
        /// <value>
        ///     The video mode.
        /// </value>
        ...
        ///     <para>
        ///         If <paramref name="monitor" /> is not <see cref="Binding.Monitor.None" />, the window will be full-screened and
        ///         dimensions ignored.
        ///     </para>
        /// </summary>
        /// <param name="monitor">The desired monitor, or <see cref="Binding.Monitor.None" /> to set windowed mode.</param>
