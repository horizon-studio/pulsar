...
namespace Pulsar.Contexts.GlfwSharp.Binding
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="glfwWindow">The window handle.</param>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void SizeCallback(GlfwWindow glfwWindow, int width, int height);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void PositionCallback(GlfwWindow glfwWindow, double x, double y);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void FocusCallback(GlfwWindow glfwWindow, bool focusing);
    ...
    /// <param name="glfwWindow">The window handle.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void WindowCallback(GlfwWindow glfwWindow);

    /// <summary>
    ///     This is the function signature for file drop callbacks.
    /// </summary>
    /// <param name="glfwWindow">The window that received the event.</param>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void FileDropCallback(GlfwWindow glfwWindow, int count, IntPtr arrayPtr);

    /// <summary>
    ///     This is the function signature for cursor position callback functions.
    /// </summary>
    /// <param name="glfwWindow">The window handle recieving the event.</param>
    /// <param name="x">The new cursor x-coordinate, relative to the left edge of the client area.</param>
    /// <param name="y">The new cursor y-coordinate, relative to the left edge of the client area.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void MouseCallback(GlfwWindow glfwWindow, double x, double y);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void MouseEnterCallback(GlfwWindow glfwWindow, bool entering);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void MouseButtonCallback(GlfwWindow glfwWindow, MouseButton button, InputState state,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void CharCallback(GlfwWindow glfwWindow, uint codePoint);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void CharModsCallback(GlfwWindow glfwWindow, uint codePoint, ModifierKeys mods);
    ...
    /// <param name="mods">	Bit field describing which modifier keys were held down.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void KeyCallback(GlfwWindow glfwWindow, Keys key, int scanCode, InputState state, ModifierKeys mods);
    ...
    /// </summary>
    /// <param name="glfwWindow">The window whose content scale changed.</param>
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void WindowContentsScaleCallback(GlfwWindow glfwWindow, float xScale, float yScale);

    /// <summary>
    ///     This is the function signature for window maximize/restore callback functions.
    /// </summary>
    /// <param name="glfwWindow">The window that was maximized or restored.</param>
    /// <param name="maximized"><c>true</c> if the window was maximized, or <c>false</c> if it was restored.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void WindowMaximizedCallback(GlfwWindow glfwWindow, bool maximized);
}