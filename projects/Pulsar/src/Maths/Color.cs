...
namespace Pulsar.Maths
{
    ...
    public partial struct Color : IEquatable<Color>
    {
        ...
        /// </summary>
        /// <param name="values">
        ///     The values to assign to the red, green, blue, or alpha components of the color. This must be an
        ///     array with four elements.
        /// </param>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="values" /> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">
        ...
        /// <param name="index">
        ///     The index of the component to access. Use 0 for the red(R) component, 1 for the green(G) component,
        ///     2 for the blue(B) component, and 3 for the alpha(A) component.
        /// </param>
        ...
        {
            return new Color((byte) (left.R + right.R), (byte) (left.G + right.G), (byte) (left.B + right.B),
                (byte) (left.A + right.A));
        }
        ...
        {
            return new Color((byte) (left.R * right.R / 255), (byte) (left.G * right.G / 255),
        ...
        {
            return new Color((byte) (255 - value.R), (byte) (255 - value.G), (byte) (255 - value.B),
                (byte) (255 - value.A));
        }
