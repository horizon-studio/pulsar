...
namespace Pulsar.Maths
{
    ...
    public abstract class SphericalHarmonics<TDataType>
    {
        ...
        /// <summary>
        ///     Get the coefficients defining the spherical harmonics (the spherical coordinates x{l,m} multiplying the spherical
        ///     base Y{l,m}).
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        ///     Returns the coefficient x{l,m} of the spherical harmonics (the {l,m} spherical coordinate corresponding to the
        ///     spherical base Y{l,m}).
        /// </summary>
            ...
            // ReSharper restore UnusedParameter.Local
        {
            if (l > maxOrder - 1)
                throw new IndexOutOfRangeException(
                    String.Format("'l' parameter should be between '0' and '{0}' (order-1).", maxOrder - 1));
