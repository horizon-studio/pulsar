...
namespace Pulsar.Maths
{
    ...
    public struct Double4 : IEquatable<Double4>, IFormattable
    {
        ...
        /// </summary>
        public bool IsNormalized => Math.Abs(X * X + Y * Y + Z * Z + W * W - 1f) < MathUtil.ZeroTolerance;
        ...
        /// <summary>
        ///     Returns a <see cref="Double4" /> containing the 4D Cartesian coordinates of a point
        ///     specified in Barycentric coordinates relative to a 4D triangle.
        /// </summary>
        /// <param name="value1">
        ///     A <see cref="Double4" /> containing the 4D Cartesian coordinates of vertex
        ///     1 of the triangle.
        /// </param>
        /// <param name="value2">
        ///     A <see cref="Double4" /> containing the 4D Cartesian coordinates of vertex
        ...
        /// </param>
        /// <returns>
        ///     A new <see cref="Double4" /> containing the 4D Cartesian coordinates of the specified
        ///     point.
        /// </returns>
        ...
        /// <remarks>
        ///     <see cref="DistanceSquared(ref Pulsar.Maths.Double4,ref Pulsar.Maths.Double4,out double)" /> may be
        ...
        /// <remarks>
        ///     <see cref="DistanceSquared(Pulsar.Maths.Double4,Pulsar.Maths.Double4)" /> may be preferred when only the
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="Double4" /> to
        ///     <see cref="Vector4" />.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Vector4" /> to
        ///     <see cref="Double4" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <returns>
        ///     <c>true</c> if the specified <see cref="Double4" /> is equal to this instance; otherwise,
        ///     <c>false</c>.
        /// </returns>
...
#if WPFInterop
        /// <summary>
        /// Performs an implicit conversion from <see cref="MathSharp.Double4"/> to <see cref="System.Windows.Media.Media3D.Point4D"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.Windows.Media.Media3D.Point4D"/> to <see cref="MathSharp.Double4"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
...
#if XnaInterop
        /// <summary>
        /// Performs an implicit conversion from <see cref="MathSharp.Double4"/> to <see cref="Microsoft.Xna.Framework.Vector4"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Vector4"/> to <see cref="MathSharp.Double4"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
