...
namespace Pulsar.Maths
{
    ...
    public struct ColorBGRA : IEquatable<ColorBGRA>, IFormattable
    {
        ...
        ///     Gets the brightness.
        /// </summary>
        /// <returns>The Hue-Saturation-Brightness (HSB) saturation for this <see cref="Pulsar.Maths.Color" /></returns>
        ...
        {
            return new ColorBGRA((byte) (left.R + right.R), (byte) (left.G + right.G), (byte) (left.B + right.B),
                (byte) (left.A + right.A));
        }
        ...
        {
            return new ColorBGRA((byte) (left.R * right.R / 255), (byte) (left.G * right.G / 255),
                (byte) (left.B * right.B / 255), (byte) (left.A * right.A / 255));
        }
        ...
        {
            return new ColorBGRA((byte) (255 - value.R), (byte) (255 - value.G), (byte) (255 - value.B),
                (byte) (255 - value.A));
        }
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Pulsar.Maths.Color" /> to <see cref="ColorBGRA" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator ColorBGRA(Pulsar.Maths.Color value)
        {
            return new ColorBGRA(value.R, value.G, value.B, value.A);
        }

        /// <summary>
        ///     Performs an implicit conversion from <see cref="ColorBGRA" /> to <see cref="Pulsar.Maths.Color" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator Pulsar.Maths.Color(ColorBGRA value)
        {
            return new Pulsar.Maths.Color(value.R, value.G, value.B, value.A);
        }
