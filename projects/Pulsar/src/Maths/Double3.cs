...
namespace Pulsar.Maths
{
    ...
    public struct Double3 : IEquatable<Double3>, IFormattable
    {
        ...
        /// </summary>
        public bool IsNormalized => Math.Abs(X * X + Y * Y + Z * Z - 1f) < MathUtil.ZeroTolerance;
        ...
        /// <remarks>
        ///     <see cref="LengthSquared" /> may be preferred when only the relative length is
        ///     needed
        ...
        /// <remarks>
        ///     This method may be preferred to <see cref="Length" /> when only a relative length
        ///     is needed
        ///     and speed is of the essence.
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        ///     Returns a <see cref="Double3" /> containing the 3D Cartesian coordinates of a point
        ///     specified in Barycentric coordinates relative to a 3D triangle.
        /// </summary>
        /// <param name="value1">
        ///     A <see cref="Double3" /> containing the 3D Cartesian coordinates of vertex
        ///     1 of the triangle.
        /// </param>
        /// <param name="value2">
        ///     A <see cref="Double3" /> containing the 3D Cartesian coordinates of vertex
        ...
        /// </param>
        /// <returns>
        ///     A new <see cref="Double3" /> containing the 3D Cartesian coordinates of the specified
        ///     point.
        /// </returns>
        ...
        /// <remarks>
        ///     <see cref="DistanceSquared(ref Pulsar.Maths.Double3,ref Pulsar.Maths.Double3,out double)" /> may be
        ///     preferred when only the relative distance is needed
        ///     and speed is of the essence.
        /// </remarks>
        ...
        /// <remarks>
        ///     <see cref="DistanceSquared(Pulsar.Maths.Double3,Pulsar.Maths.Double3)" /> may be preferred when only the
        ///     relative distance is needed
        ///     and speed is of the essence.
        /// </remarks>
            ...
            double amount, out Double3 result)
        {
            ...
            var part1 = 2.0f * cubed - 3.0f * squared + 1.0;
        ...
        /// <param name="result">
        ///     When the method completes, contains the transformed <see cref="Double4" />
        ///     .
        /// </param>
        ...
        /// <param name="transform">The transformation <see cref="Matrix" />.</param>
        /// <param name="result">
        ///     When the method completes, contains the transformed <see cref="Double3" />
        ///     .
        /// </param>
        ...
        {
            var invW = 1f / (coordinate.X * transform.M14 + coordinate.Y * transform.M24 +
                             coordinate.Z * transform.M34 + transform.M44);
            result = new Double3(
                (coordinate.X * transform.M11 + coordinate.Y * transform.M21 + coordinate.Z * transform.M31 +
                 transform.M41) * invW,
                (coordinate.X * transform.M12 + coordinate.Y * transform.M22 + coordinate.Z * transform.M32 +
                 transform.M42) * invW,
                (coordinate.X * transform.M13 + coordinate.Y * transform.M23 + coordinate.Z * transform.M33 +
                 transform.M43) * invW);
        }
        ...
        public static void RotationYawPitchRoll(ref Quaternion quaternion, out Double3 yawPitchRoll)
        {
            ...
            Quaternion.RotationYawPitchRoll(ref quaternion, out yawPitchRollV.X, out yawPitchRollV.Y,
                out yawPitchRollV.Z);
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="Double3" /> to
        ///     <see cref="Vector3" />.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <returns>
        ///     <c>true</c> if the specified <see cref="Double3" /> is equal to this instance; otherwise,
        ///     <c>false</c>.
        /// </returns>
...
#if WPFInterop
        /// <summary>
        /// Performs an implicit conversion from <see cref="MathSharp.Double3"/> to <see cref="System.Windows.Media.Media3D.Double3D"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.Windows.Media.Media3D.Double3D"/> to <see cref="MathSharp.Double3"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
...
#if XnaInterop
        /// <summary>
        /// Performs an implicit conversion from <see cref="MathSharp.Double3"/> to <see cref="Microsoft.Xna.Framework.Vector3"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Vector3"/> to <see cref="MathSharp.Double3"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
