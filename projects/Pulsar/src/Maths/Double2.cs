...
namespace Pulsar.Maths
{
    ...
    public struct Double2 : IEquatable<Double2>, IFormattable
    {
        ...
        /// </summary>
        public bool IsNormalized => Math.Abs(X * X + Y * Y - 1f) < MathUtil.ZeroTolerance;
        ...
        /// <summary>
        ///     Returns a <see cref="Double2" /> containing the 2D Cartesian coordinates of a point
        ///     specified in Barycentric coordinates relative to a 2D triangle.
        /// </summary>
        /// <param name="value1">
        ///     A <see cref="Double2" /> containing the 2D Cartesian coordinates of vertex
        ///     1 of the triangle.
        /// </param>
        /// <param name="value2">
        ///     A <see cref="Double2" /> containing the 2D Cartesian coordinates of vertex
        ...
        /// </param>
        /// <returns>
        ///     A new <see cref="Double2" /> containing the 2D Cartesian coordinates of the specified
        ///     point.
        /// </returns>
        ...
        /// <remarks>
        ///     <see cref="DistanceSquared(ref Pulsar.Maths.Double2,ref Pulsar.Maths.Double2,out double)" /> may be
        ...
        /// <remarks>
        ///     <see cref="DistanceSquared(Pulsar.Maths.Double2,Pulsar.Maths.Double2)" /> may be preferred when only the
        ...
        /// <summary>
        ///     Performs an explicit conversion from <see cref="Double2" /> to
        ///     <see cref="Vector2" />.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="Vector2" /> to
        ///     <see cref="Double2" />.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <returns>
        ///     <c>true</c> if the specified <see cref="Double2" /> is equal to this instance; otherwise,
        ///     <c>false</c>.
        /// </returns>
...
#if WPFInterop
        /// <summary>
        /// Performs an implicit conversion from <see cref="MathSharp.Double2"/> to <see cref="System.Windows.Point"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.Windows.Point"/> to <see cref="MathSharp.Double2"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
...
#if XnaInterop
        /// <summary>
        /// Performs an implicit conversion from <see cref="MathSharp.Double2"/> to <see cref="Microsoft.Xna.Framework.Vector2"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Microsoft.Xna.Framework.Vector2"/> to <see cref="MathSharp.Double2"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
